      ...
      <div className=' w-full flex flex-col justify-center p-4 '>
        <div className=' w-full bg-white h-auto rounded-xl shadow-lg'>
          ...
          <div className='w-full p-4 border-t-2 border-t-primary rounded-t-xl flex justify-between items-center border-b-2 border-b-light-gray'>
            <h1 className='text-xl font-semibold text-dark-gray'>Appointment List</h1>
            <div className='flex gap-3'>
              <button className=' bg-medium-gray text-white flex justify-start items-center pl-4 pr-8 py-2 cursor-pointer rounded-md font-bold capitalize ' onClick={() => navigate("/admin/dashboard/history")}><AiOutlineHistory size={30} />&nbsp;History</button>
              <button className=' bg-primary text-white flex justify-start items-center pl-1 pr-6 py-2 cursor-pointer rounded-md font-bold capitalize ' onClick={() => setModal(true)}><IoAdd size={30} />&nbsp;Add Appointment</button>
            </div>
          </div>
          ...
          <div className=' w-full p-4 flex justify-between '>
            ...
            <input
              ...
              placeholder="Search patient's appointment..."
