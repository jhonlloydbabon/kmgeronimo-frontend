  ...
  return (
    <div className='w-full h-screen bg-gray-100 flex z-10 '>
      ...
      <div className=' flex flex-grow flex-col bg-gray-200 '>
        ...
        <Routes>
          <Route
            element={<Home patients={patients.length} pendingAppointment={pendingAppointment.length} approvedAppointment={approvedAppointment.length} />}
            path='/'
          />
          ...
          <Route element={<Messages admin={admin} />} path='/messages' />

          <Route element={<Dentist />} path='/dentist' />

          <Route element={<Patients patients={patients} />} path='/patient' />
